...
__all__ = [
    ...
    # contest
    "Contest", "TrainingProgram", "Announcement",
    # user
    "User", "Team", "Participation", "TrainingProgramParticipation",
    "Message", "Question",
    # admin
    "Admin",
    # task
...
from .user import User, Team, Participation, TrainingProgramParticipation, \
    Message, Question
