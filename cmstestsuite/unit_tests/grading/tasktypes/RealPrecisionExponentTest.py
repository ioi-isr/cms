...
class TestRealPrecisionExponentDerivation(unittest.TestCase):
    ...
    def test_uses_custom_exponent(self):
        ...
        success, outcome, text, _ = eval_output(fc, job, None, use_realprecision=True, realprecision_exponent=4, user_output_digest="user")
    ...
    def test_defaults_to_6_when_missing(self):
        ...
        fc = self.make_file_cacher(user_text="0.00005", correct_text="0")
        success, outcome, text, _ = eval_output(fc, job, None, use_realprecision=True, realprecision_exponent=None, user_output_digest="user")
        self.assertTrue(success)
    ...
    def test_uses_custom_exponent_batch_style(self):
        ...
        fc = self.make_file_cacher(user_text="0.00005", correct_text="0")
        success, outcome, text, _ = eval_output(
