...
PACKAGE_DATA = {
    ...
    "cmstestsuite": [
        ...
        "tasks/batch_comparator_cpp/code/*",
        "tasks/batch_comparator_cpp/data/*",
        ...
        "tasks/communication_stdio_cpp/code/*",
        "tasks/communication_stdio_cpp/data/*",
        ...
        "tasks/outputonly_comparator_cpp/code/*",
        "tasks/outputonly_comparator_cpp/data/*",
        "tasks/twosteps/code/*.*",
        "tasks/twosteps/data/*.*",
...
setup(
    ...
    entry_points={
        ...
        "cms.grading.languages": [
            ...
            "C++ / g++=cms.grading.languages.cpp20_gpp:Cpp20Gpp",
